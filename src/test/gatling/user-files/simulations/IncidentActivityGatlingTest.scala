...
/**
 * Performance test for the IncidentActivity entity.
 */
class IncidentActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the IncidentActivity entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all incidentActivities")
            .get("/incidentmodule/api/incident-activities")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created incidentActivity")
                .get("/incidentmodule${new_incidentActivity_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created incidentActivity")
            .delete("/incidentmodule${new_incidentActivity_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }

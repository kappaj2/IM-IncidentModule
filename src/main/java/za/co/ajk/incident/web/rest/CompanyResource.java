...
public class CompanyResource {
    ...
    /**
     * PUT  /v1/companies : Updates an existing company.
     *
    ...
    /**
     * GET  /v1/companies : get all the companies.
     *
    ...
    /**
     * GET  /v1/companies/:id : get the "id" company.
     *
    ...
    /**
     * DELETE  /v1/companies/:id : delete the "id" company.
     *
    ...
    /**
     * SEARCH  /v1/_search/companies?query=:query : search for the company corresponding
     * to the query.
     *
     * @param query the query of the company search
     * @return the result of the search
     */
    @GetMapping("/v1/_search/companies")
    @Timed

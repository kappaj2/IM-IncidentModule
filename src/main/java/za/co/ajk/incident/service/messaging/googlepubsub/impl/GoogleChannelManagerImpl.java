package za.co.ajk.incident.service.messaging.googlepubsub.impl;
...
import za.co.ajk.incident.config.PubSubMessagingProperties;
import za.co.ajk.incident.enums.PubSubMessageType;
import za.co.ajk.incident.service.messaging.IMMessageProcessor;
import za.co.ajk.incident.service.messaging.InterModulePubSubMessage;
import za.co.ajk.incident.service.messaging.googlepubsub.GoogleChannelManager;
...
public class GoogleChannelManagerImpl implements GoogleChannelManager {
    ...
    @Bean
    public PubSubInboundChannelAdapter messageChannelAdapterEventSub(
